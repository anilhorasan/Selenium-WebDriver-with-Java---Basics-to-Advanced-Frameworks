...
public class Chapter13_01_Miscellaneous_Topics_in_Selenium_Webdriver {
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		//First check for just one link that you are writing the right code!
		//Working link:
		...
		// Then convert your code to automate your test: 
		...
		for(WebElement we: links) {
			...
			System.out.println("CODE: " + responseCode +"  Link: " + we.getText());
			
			// Soft Assertion:
			sa.assertTrue(responseCode<400, "ERROR in opening: " + we.getText());
			
			// For HARD assertion you can comment it out:
			/*if(responseCode > 400) {
			*	System.out.println("The link with the text: " + we.getText() + 
